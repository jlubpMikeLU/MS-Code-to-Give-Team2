...
export function StudentSettings({ student }: StudentSettingsProps) {
  ...
  const [reachUpdates, setReachUpdates] = useState(true);
  ...
  const recentActivity = [
    { action: 'Completed Alphabet recognition Worksheet', time: '2 hours ago', points: 15 },
    { action: 'Point and read Practice', time: '1 day ago', points: 20 },
    { action: 'Phonemic awareness exercise', time: '2 days ago', points: 25 },
    { action: 'Vocabulary exercise', time: '3 days ago', points: 10 }
  ];
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            <Avatar className="h-16 w-16">
              <AvatarImage 
                src="https://cdn.tatlerasia.com/tatlerasia/i/2022/02/08121954-gettyimages-691225314_cover_1500x1000.jpg" 
                alt={student.name}
              />
              <AvatarFallback>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch 
                checked={reachUpdates} 
                onCheckedChange={setReachUpdates}
              />
            </div>
